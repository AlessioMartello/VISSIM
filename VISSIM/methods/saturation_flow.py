...
satflow_filename = str(project_name) + "_Satflow_" + now.strftime("%d-%m_%H.%M") + ".xlsx"
satflow_output = data_outputs_path.joinpath(satflow_filename)
writer = pd.ExcelWriter(satflow_output)
